...
/**
 * This class is defined to implement the Excel read and write operations
 * @author Team Elite
 * Date:28/03/2022 
 */
import java.io.File;
...
public class ExcelData extends Base {
	...
	public static String path = System.getProperty("user.dir") + "\\ExcelData\\Inputread.xlsx"; // Fetching excel file
																								// from directory
	...
	public static void writeExcel(String[] name, String[] price1, String[] totalPrice) throws Exception // Passing
																										// values to
																										// excel sheet
																										// to save it
	{

		String path1 = System.getProperty("user.dir") + "\\ExcelData\\Output.xlsx"; // Fetching excel file from
																					// directory
		file = new File(path1);
		fin = new FileInputStream(file);
		wb = new XSSFWorkbook(fin);
